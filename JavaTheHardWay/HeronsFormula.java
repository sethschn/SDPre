public class HeronsFormula{
  ...
  //1. the one that uses a function is shorter
  //2. the one without a function would take longer to fix
  //3. it was not difficult to add another due to the function.
}
